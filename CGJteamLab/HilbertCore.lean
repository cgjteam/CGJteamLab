...
the geometry library.  The public relation is the smallest equivalence
relation generated by `UnorientedAngleCongruent`; consequently its
reflexivity, symmetry, and transitivity are representation laws rather
than axioms attached to any historical geometry.  For Hilbert models
this is the equality-like behavior established mathematically by
Theorem 19.
-/
def AngleCongruent
    (Geo : Geometry.Geo)
