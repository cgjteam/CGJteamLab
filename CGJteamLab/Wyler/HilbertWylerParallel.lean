...
/-!
# Hilbert-Wyler spatial parallel core

This module extracts the reusable spatial-parallel machinery developed
in Euclid XI.5-XI.6.

It imports no numbered Book XI proposition module.
...
The intermediate XI6-prefixed helper names are retained in this first
dependency-inversion pass.  They can be renamed semantically after the
module compiles independently.
-/

/--
Local bridge from the generated-plane API to the lower XI.4 metric core.

This keeps HilbertWylerParallel compatible with the already compiled
HilbertWylerMetric version exposing `hilbert_XI4_line_perpendicular_plane_core`.
-/
theorem hilbertLinePerpendicularPlaneAt_of_two_plane_lines_parallel_wyler
...
theorem hilbert_three_common_perpendiculars_coplanar_wyler
    [H : HilbertIncidence Geo]
    [HilbertPlaneIncidence Geo]
    [S : HilbertSpacePrimitive Geo]
    [HSI : HilbertSpaceIncidence Geo]
...
theorem hilbert_XI6_auxiliary_perpendicular_equal_segment_wyler
    [H : HilbertIncidence Geo]
    [HilbertPlaneIncidence Geo]
    [S : HilbertSpacePrimitive Geo]
    [HSI : HilbertSpaceIncidence Geo]
...
theorem hilbert_XI6_noncollinear_sameRay_first_wyler
    [H : HilbertIncidence Geo]
    [HilbertPlaneIncidence Geo]
    (A A' O B : Geo.Point)
...
theorem hilbert_XI6_noncollinear_sameRay_second_wyler
    [H : HilbertIncidence Geo]
    [HilbertPlaneIncidence Geo]
    (A O B B' : Geo.Point)
    (hAOB : Not (PrimCollinear Geo A O B))
  ...
  have hB'OA :
    ...
    hilbert_XI6_noncollinear_sameRay_first_wyler
      (Geo := Geo)
      B B' O A
      hBOA hRay
...
theorem hilbert_XI6_space_angle_sameRay_second_congruent_wyler
    [H : HilbertIncidence Geo]
    [HilbertPlaneIncidence Geo]
    [S : HilbertSpacePrimitive Geo]
    [HSI : HilbertSpaceIncidence Geo]
...
theorem hilbert_XI6_space_adjacent_angles_congruent_in_plane_wyler
    [H : HilbertIncidence Geo]
    [HilbertPlaneIncidence Geo]
    [S : HilbertSpacePrimitive Geo]
    [HSI : HilbertSpaceIncidence Geo]
  ...
  have hXOB_XOY :
    ...
    hilbert_XI6_space_angle_sameRay_second_congruent_wyler
      (Geo := Geo)
      X O B Y
      hXOB hBY
  ...
  have hXOY :
    ...
    hilbert_XI6_noncollinear_sameRay_second_wyler
      (Geo := Geo)
      X O B Y
      hXOB hBY
...
theorem hilbert_XI6_space_right_angles_congruent_in_plane_wyler
    [H : HilbertIncidence Geo]
    [HilbertPlaneIncidence Geo]
    [S : HilbertSpacePrimitive Geo]
    [HSI : HilbertSpaceIncidence Geo]
  ...
  have hSupp :
      Geo.AngleCongruent
        B O C
        K O'.1 C0 :=
    hilbert_XI6_space_adjacent_angles_congruent_in_plane_wyler
      (Geo := Geo)
      sigma
      A O B C
      A' O' Kp C0p
...
theorem hilbert_XI6_space_linesPerpendicularAt_right_angle_of_points_wyler
    [H : HilbertIncidence Geo]
    [HilbertPlaneIncidence Geo]
    [S : HilbertSpacePrimitive Geo]
    [HSI : HilbertSpaceIncidence Geo]
...
theorem hilbert_XI6_first_SAS_wyler
    [H : HilbertIncidence Geo]
    [HilbertPlaneIncidence Geo]
    [S : HilbertSpacePrimitive Geo]
    [HSI : HilbertSpaceIncidence Geo]
  ...
  rcases
      hilbert_XI6_auxiliary_perpendicular_equal_segment_wyler
        (Geo := Geo)
        pi
        A B D
        hBpi hDpi hBD
  ...
  have hABD :=
    hilbert_XI6_space_linesPerpendicularAt_right_angle_of_points_wyler
      (Geo := Geo)
      l d
      B A D
      hPerpLd
...
theorem hilbert_XI6_space_right_angle_transport_in_plane_wyler
    [H : HilbertIncidence Geo]
    [HilbertPlaneIncidence Geo]
    [S : HilbertSpacePrimitive Geo]
    [HSI : HilbertSpaceIncidence Geo]
...
theorem hilbert_XI6_second_SSS_right_angle_wyler
    [H : HilbertIncidence Geo]
    [HilbertPlaneIncidence Geo]
    [S : HilbertSpacePrimitive Geo]
    [HSI : HilbertSpaceIncidence Geo]
  ...
  have hRightEDA :
    ...
    hilbert_XI6_space_right_angle_transport_in_plane_wyler
      (Geo := Geo)
      tau
      A B E
      Etau Dtau Atau
...
theorem hilbert_XI6_normals_to_same_plane_coplanar_wyler
    [H : HilbertIncidence Geo]
    [HilbertPlaneIncidence Geo]
    [S : HilbertSpacePrimitive Geo]
    [HSI : HilbertSpaceIncidence Geo]
...
theorem hilbert_XI6_coplanar_normals_disjoint_wyler
    [H : HilbertIncidence Geo]
    [HilbertPlaneIncidence Geo]
    [S : HilbertSpacePrimitive Geo]
    [HSI : HilbertSpaceIncidence Geo]
