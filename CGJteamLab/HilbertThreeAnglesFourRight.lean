...
/--
Replace the first summand in `HilbertTwoAnglesGreaterThanAngle`
by a congruent proper angle.
-/
...
/--
Replace the second summand in `HilbertTwoAnglesGreaterThanAngle`
by a congruent proper angle.
-/
